...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class RotationAction
    {
        ...
        [Min(0f)]
        [SerializeField]
        float speedRotateSelf = 2f;

        [Min(0f)]
        [SerializeField]
        float speedRotatePivot = 2f;
        ...
        public void Tick(float dt, ref Vector3 position, ref Quaternion rotation)
        {
            ...
            else
            {
                ...
                if (isWaiting)
                    ...
                    actionVector = CustomUtilities.Multiply(direction, speedRotateSelf, dt);
            }
            ...
            rotation *= Quaternion.AngleAxis(speedRotateSelf * dt, direction);
        }
        ...
        void RotateAround(ref Vector3 position, ref Quaternion rotation, float dt)
        {
            ...
            Quaternion thisRotation = Quaternion.AngleAxis(speedRotatePivot * dt, direction);
    ...
    public class RotationActionDrawer : PropertyDrawer
    {
        ...
        SerializedProperty speedRotateSelf = null;
        SerializedProperty speedRotatePivot = null;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            speedRotateSelf = property.FindPropertyRelative("speedRotateSelf");
            speedRotatePivot = property.FindPropertyRelative("speedRotatePivot");
            ...
            if (enabled.boolValue)
            {
                ...
                EditorGUI.PropertyField(fieldRect, speedRotateSelf);
                fieldRect.y += fieldRect.height;

                EditorGUI.PropertyField(fieldRect, pivotObject);
                fieldRect.y += fieldRect.height;

                if(pivotObject.objectReferenceValue)
                {
                    EditorGUI.PropertyField(fieldRect, speedRotatePivot);
                    fieldRect.y += fieldRect.height;
                }
