...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    public class AboutWindow : CharacterControllerProWindow
    {
        ...
        void OnGUI()
        {
            EditorGUILayout.SelectableLabel("Version: 1.4.1", GUILayout.Height(15f));
    ...
    public class WelcomeWindow : CharacterControllerProWindow
    {
        ...
        [MenuItem("Window/Character Controller Pro/Upgrade guide 1.4.0", false, 0)]
        public static void OpenUpgradeGuide()
        {
            //string[] results = AssetDatabase.FindAssets("Upgrade guide 1.4.0");
            //if (results.Length != 0)
            //{
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("<b>Upgrade to 1.4.0</b>", subtitleStyle);

            GUILayout.Label("Are you upgrading to 1.4.x?\nGo and take a look a the <b>upgrade guide</b> (<i>Character Controller Pro/Documentation/Upgrade guide 1.4.0.pdf</i>)", descriptionStyle);
