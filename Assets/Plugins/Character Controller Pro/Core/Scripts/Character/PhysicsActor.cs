...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    public abstract class PhysicsActor : MonoBehaviour
    {
        ...
        {
            get => Vector3.ProjectOnPlane(Velocity, Up);
            set => Velocity = Vector3.ProjectOnPlane(value, Up) + VerticalVelocity;
        }
        ...
        {
            get => Vector3.Project(Velocity, Up);
            set => Velocity = PlanarVelocity + Vector3.Project(value, Up);
        }
        ...
        /// </summary>         
        public void RotateAround(Quaternion deltaRotation, Vector3 pivot)
        {
        ...
        public void RotateYaw(float angle, Vector3 pivot)
        {
        ...
        /// <param name="angle">The angle in degrees.</param>       
        /// <param name="pivot">The rotation pivot in space.</param>      
        public void RotatePitch(float angle, Vector3 pivot)
        {
        ...
        /// <param name="angle">The angle in degrees.</param>        
        /// <param name="pivot">The rotation pivot in space.</param>     
        public void RotateRoll(float angle, Vector3 pivot)
        {
