...
namespace FluffyUnderware.Curvy.Generator.Modules
{
    ...
    public class BuildShapeExtrusion : CGModule, IPathProvider
    {
        ...
        /// <summary>
        /// When using <see cref="ScaleMode"/> == ScaleModeEnum.Advanced, this curve defines a scale multiplier relatively to the Relative Distance of a point on the path.
...
#pragma warning restore 618
                ...
                SubArray<float> scaleRelativeDistancesArray = ScaleReference == CGReferenceMode.Source ? path.SourceRelativeDistances : path.RelativeDistances;
                ...
                for (int sample = 0; sample < samplesCount; sample++)
                {
                    ...
                    getScaleInternal(scaleRelativeDistancesArray.Array[sample], baseScale, ref scl);
        ...
        public Vector3 GetScale(float relativeDistance)
        {
            ...
            getScaleInternal(relativeDistance, baseScale, ref res);
            return res;
        }
        ...
        private void getScaleInternal(float relativeDistance, Vector3 baseScale, ref Vector3 scale)
        {
            if (ScaleMode == ScaleModeEnum.Advanced)
            {
                float scf = DTMath.Repeat(relativeDistance - ScaleOffset, 1);
