                     ...
                     //Optimized version of outputMeshVertex[vertexShitIndex] = (deltaRotation * vertexPositionDelta) + (positionOnPathMeshSpace);
                     {
                         Vector3 outputVertex;
                         {
                             outputVertex.x = positionOnPathMeshSpace.x +
                                              (1.0f - (formulaNumber_5 + formulaNumber_6)) * vertexPositionDelta.x
                                              + (formulaNumber_7 - formulaNumber_12) * vertexPositionDelta.y;
                             ...
                             outputVertex.y = positionOnPathMeshSpace.y +
                                              (formulaNumber_7 + formulaNumber_12) * vertexPositionDelta.x
                                              + (1.0f - (formulaNumber_4 + formulaNumber_6)) * vertexPositionDelta.y;
                             ...
                             outputVertex.z = positionOnPathMeshSpace.z +
                                              (formulaNumber_8 - formulaNumber_11) * vertexPositionDelta.x
                                              + (formulaNumber_9 + formulaNumber_10) * vertexPositionDelta.y;
